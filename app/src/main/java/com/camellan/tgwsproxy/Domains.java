...
final class Domains {
    ...
    static final Map<Integer,String> WS_IP = new HashMap<>();

    static {
        // Реальные Telegram DC
        ...
        // IP, через который устанавливаем WSS
        WS_IP.put(1, "149.154.175.50");
        WS_IP.put(2, "149.154.167.220");
        WS_IP.put(3, "149.154.175.100");
        WS_IP.put(4, "149.154.167.220");
        WS_IP.put(5, "149.154.167.220");
        WS_IP.put(203, "149.154.167.220");
    }
